  ...
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="服务商" prop="service">
        <el-input
          v-model:value="queryParams.service"
          placeholder="请输入服务商"
          clearable
          size="small"
          @keyup.enter="handleQuery"
    ...
    >
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="文件名">
          <fileUpload v-model:value="form.file" v-if="type === 0" />
          <imageUpload v-model:value="form.file" v-if="type === 1" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handlePreviewListResource(previewListResource) {
      ...
      this.$confirm('确认要"' + text + '""预览列表图片"配置吗?', '警告', {
        confirmButtonText: '确定',
        cancelButtonText: '取消',
        type: 'warning',
      })
