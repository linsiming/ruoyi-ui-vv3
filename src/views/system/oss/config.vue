  ...
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="桶名称" prop="bucketName">
        <el-input
          v-model:value="queryParams.bucketName"
          placeholder="请输入桶名称"
          clearable
          size="small"
    ...
    >
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        <el-form-item label="配置key" prop="configKey">
          <el-select v-model:value="form.configKey" placeholder="请选择配置key">
            <el-option
              v-for="configKey in configKeyOptions"
              :key="configKey.configKey"
              :label="configKey.label"
        ...
        <el-form-item label="前缀" prop="prefix">
          <el-input v-model:value="form.prefix" placeholder="请输入前缀" />
        </el-form-item>
        <el-form-item label="是否HTTPS">
          <el-radio-group v-model:value="form.isHttps">
            <el-radio
        ...
        <el-form-item label="域" prop="region">
          <el-input v-model:value="form.region" placeholder="请输入域" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm(
        '是否确认删除云存储配置编号为"' + ossConfigIds + '"的数据项?',
        '警告',
        {
