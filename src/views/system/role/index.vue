<template>
  <div class="app-container">
    ...
    >
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item prop="roleKey">
          ...
          <el-input v-model:value="form.roleKey" placeholder="请输入权限字符" />
        </el-form-item>
        ...
        <el-form-item label="菜单权限">
          <el-checkbox
            v-model:value="menuExpand"
            @change="handleCheckedTreeExpand($event, 'menu')"
            >展开/折叠</el-checkbox
          >
          <el-checkbox
            v-model:value="menuNodeAll"
    ...
    <el-dialog
      :title="title"
      v-model:value:visible="openDataScope"
      width="500px"
      append-to-body
    >
      <el-form :model="form" label-width="80px">
        ...
        <el-form-item label="权限字符">
          <el-input v-model:value="form.roleKey" :disabled="true" />
        </el-form-item>
        ...
        <el-form-item label="数据权限" v-show="form.dataScope == 2">
          <el-checkbox
            v-model:value="deptExpand"
            @change="handleCheckedTreeExpand($event, 'dept')"
            >展开/折叠</el-checkbox
          >
          <el-checkbox
            v-model:value="deptNodeAll"
